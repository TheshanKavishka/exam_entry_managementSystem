...
<body style="background-color: rgb(255, 255, 255)" class="mr-3">
  ...
  <div class="container">
    ...
    <form action="{{ route('lecture.create')}}" method="get" enctype="multipart/form-data">
    <!-- new -->
  <div class="row">
    ...
    <div class="card my-4">
      <div class="card-body cd">
        ...
        <select class="form-select" name="dep" required aria-label="Default select example">
            <option selected>Open this select menu</option>
            <option value="Department of bio-science">Applied Science -Department of bio-science</option>
            <option value="Department of physical science">Applied Science -Department of physical science</option>
            <option value="Technological Studies">Technological Studies -Department of ICT</option>
  ...
  <div class="col-sm-4">
    <div class="card my-4">
      <div class="card-body cd">
        ...
        {{-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
         --}}
         <select class="form-select" name="fac" required aria-label="Default select example">
            <option selected>Open this select menu</option>
...
<br>
<p>Select the Year, Department, Faculty that you teach and click on "select the courses" button to display the courses that you are currently teaching. 
 Then click on the link "check" to get the student who submitted exam entry forms. 
</p>
    ...
    @foreach ($courses as $c)
      <tr>
        ...
        {{-- <td><div class="form-check form-switch">
          ...
          <td><a href="{{route('lecture.show',$c->id)}}"  class="link-primary">Check</a></td>
        </td>
 ...
 {{-- signeture upload end --}}
  ...
  <div class="card my-4 text-black"style="background-color: #90EE90" >
      <div class="card-body">
        ...
        Click link to recommend students for exam
        <h6 class="mt-5 mb-4" style="color: rgb(255, 0, 0)">Due Date : 28/04/2023</h6>
