...
<body style="background-color: rgb(255, 255, 255)" class="mr-3">
  ...
  <div class="container">
    ...
    <form action="{{ route('dr.create')}}" method="get" enctype="multipart/form-data">
    <!-- new -->
  <div class="row">
  ...
  <p>Select the Year, Faculty, Department and click on "select the courses" button to display the courses are present in particular faculty. 
    ...
    @foreach ($course as $c)
      <tr>
        ...
        {{-- <td><div class="form-check form-switch">
          ...
          <td><a href="{{route('dr.show',$c->id)}}"  class="link-primary">Check</a></td>
        </td>
    ...
    <div class="card my-4 text-white" style="background-color: #90EE90">
      <div class="card-body">
        ...
        <div class="container col-md-6">
            <form action="{{route('dr.store')}}" method="post" enctype="multipart/form-data">
                @csrf
            <div class="mb">
 ...
 {{-- signeture upload end --}}
  ...
  <div class="card my-4 text-black"style="background-color: #90EE90" >
      <div class="card-body">
        ...
        <h6 style="color: black">Click on check link to recommend each application of student for exam</h6>
        <h6 class="mt-5 mb-4" style="color: rgb(255, 0, 0)">Due Date : 30/06/2023</h6>
