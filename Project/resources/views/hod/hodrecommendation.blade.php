...
<body style="background-color: rgb(255, 255, 255)" class="mr-3">
  <nav class="navbar navbar custom">
    <a class="btn btn-outline-dark me-3" href="{{route('hoddashboard')}}"  ><i class="bi bi-arrow-return-left" style="color: #fff"></i></a>
  ...
  <div class="text-white mb-5 m-5">
      ...
      @foreach ($exam as $e)
        <tr>
          ...
          <td><div class="form-check form-switch">
              <input class="form-check-input " type="checkbox" onchange="coursedata({{$e->id}})" id="">
            </div>
    ...
    <form action="{{route('hod.update','1')}}" method="post" id="dataform">
        @method('PUT')
        @csrf
